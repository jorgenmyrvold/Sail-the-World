...
class DCMotor:
    ...
    def __init__(self, pwm_pin, pin_out_1, pin_out_2, orientation_of_motor, stop_percentage = 0):
        ...
        GPIO.setup(self.pin1, GPIO.OUT, pull_up_down=GPIO.PUD_DOWN) #Pull down the pin when not high
        GPIO.setup(self.pin2, GPIO.OUT, pull_up_down=GPIO.PUD_DOWN) #Pull down the pin when not high
